...
![Spreadsheet selection](/img/Selection_004.png "Spreadsheet selection")
...
![Paste as markup](/img/Selection_005.png "Paste as markup")
...
![Preview with other text](/img/Selection_009.png "Preview with other text")
...
![Wide selection](/img/Selection_010.png "Wide selection")

Then right-click on the Jira comment field and select "Paste Transposed Jira
Table Markup":

![Transposed menu entry](/img/Selection_011.png "Transposed menu entry")

The pasted markup looks as follows:

![Transposed markup](/img/Selection_014.png "Transposed markup")

And if we preview it as before, we see the following, which is more readable
than a 10 column table with 2 rows of data:

![Transposed preview](/img/Selection_013.png "Transposed preview")
...
![Paste escaped](/img/Selection_016.png "Paste escaped")

![Pasted text](/img/Selection_017.png "Pasted text")

...and the asterisks are escaped so the rendered result is not bolded:

![Pasted text](/img/Selection_018.png "Pasted text")
